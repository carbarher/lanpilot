...
fn map_key_to_vk(key: &str) -> Option<u8> {
    ...
    match key {
        ...
        "LeftCtrl" | "LControl" | "Control" => Some(0xA0), // VK_LCONTROL
        "RightCtrl" | "RControl" => Some(0xA1), // VK_RCONTROL
        "LeftShift" | "LShift" | "Shift" => Some(0xA2), // VK_LSHIFT
        "RightShift" | "RShift" => Some(0xA3), // VK_RSHIFT
        "LeftAlt" | "LAlt" | "Alt" => Some(0xA4), // VK_LMENU
        "RightAlt" | "RAlt" => Some(0xA5), // VK_RMENU
        "Left" => Some(0x25), // VK_LEFT
        "Up" => Some(0x26), // VK_UP
        "Right" => Some(0x27), // VK_RIGHT
        "Down" => Some(0x28), // VK_DOWN
        "LWin" | "Win" | "Meta" | "LeftSuper" => Some(0x5B), // VK_LWIN
        "RWin" | "RightSuper" => Some(0x5C), // VK_RWIN
        "Menu" => Some(0x5D), // VK_APPS (Menu Contextual)
        ...
        "PrintScreen" => Some(0x2C), // VK_SNAPSHOT
